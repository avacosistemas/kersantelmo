<?php include("header.php");?>
        ...
        <div class="habitaciones_detalle">
	        <div class="container">
		        <div class="col-md-12"><h1>HABITACI&Oacute;N <span>SUPERIROR</span></h1></div>
	        <div class="col-md-8 borde">
		        ...
		        <p>
			        Amplias habitaciones de 30 m² con vista a
Puerto Madero.<br>
Internet WIFI.<br>
...
Detectores de humo.<br>
        ...
        <form action="https://reservations.travelclick.com/110467#/guestsandrooms" method="get" target="_blank">
	        ...
	        <img src="img/_habitaciones/02Superior_Banner_inferior_Superior.jpg" alt="01Classic_Banner_inferior_Classic" class="foto img-responsive">
        </div>
