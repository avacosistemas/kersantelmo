...
if($tipo == 'Halo reserva'){
	...
	mail( 'kerhoteles@kerhoteles.com.ar', "Contacto - Halo Reserva", $html,  $cabeceras );	
	
} else if($tipo == 'Salones Cotizacion'){

	mail( 'kerhoteles@kerhoteles.com.ar', "Contacto - Salones Cotizacion", $html,  $cabeceras );

} else if($tipo == 'spa'){

	mail( 'kerhoteles@kerhoteles.com.ar', "Contacto - SPA", $html,  $cabeceras );	
