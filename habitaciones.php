<?php include("header.php");?>
        ...
        <div class="habitaciones">
	        ...
	        <div class="blanco"><!--  -->
		        <div class="col-md-6">
			        <h1>Classic</h1>
			        <p>Confortables habitaciones de 25 y 30 m2 <i>(Sgl, Dbl, Tpl, Cple)</i> con vista al Casco Histórico de la Ciudad y a Puerto Madero.
</p>
			        <a href="habitaciones_classic.php">RESERV&Aacute;</a>
		        </div>
		        <div class="col-md-6 nopad">
			        <div class="carousel1">
				        ...
				        <div class="item"><img src="img/KER_SAN_TELMO_WebSite_Habitaciones_Classic_Triple_01.jpg" alt="Classic_00"></div>
				        <div class="item"><img src="img/KER_SAN_TELMO_WebSite_Habitaciones_Classic_Cuadruple_02.jpg" alt="Classic_00"></div>
			        </div>
		        </div>
		        <div class="clear"></div>
	        </div><!--  -->
	        
	        <div class="gris" style="display:none;"><!--  -->
	        <div class="col-md-6 hidden-md hidden-lg hidden-sm">
			        <h1>Superior</h1>
			        <p>Amplias habitaciones de 30 m² con vista a Puerto Madero.</p>
			        <a href="habitaciones_superior.php">RESERV&Aacute;</a>
		        </div>
	        <div class="col-md-6 nopad">
			        <div class="carousel1">
				        <div class="item"><img src="img/_habitaciones/02_Superior/Superior_00.jpg" alt="Classic_00"></div>
				        <div class="item"><img src="img/_habitaciones/02_Superior/Superior_01.jpg" alt="Classic_00"></div>
				        <div class="item"><img src="img/_habitaciones/02_Superior/Superior_02.jpg" alt="Classic_00"></div>
				        <div class="item"><img src="img/_habitaciones/02_Superior/Superior_03.jpg" alt="Classic_00"></div>
			        </div>
		        </div>
	        ...
	        <div class="gris"><!--  -->
		        ...
		        <div class="col-md-6">
			        <h1>Executive</h1>
			        <p>Amplias habitaciones de 30 m2 con vista al Casco Histórico de la Ciudad y a Puerto Madero.
Cuenta con cafetera de cápsula y mesa de trabajo adicional
</p>
	        ...
	        <div class="col-md-6">
			        <h1>Deluxe</h1>
			        <p>Habitaciones con dos ambientes integrados 
...
También un sofá para mayor comodidad.</p>
			        <a href="habitaciones_deluxe.php">RESERV&Aacute;</a>
		        </div>
	        <div class="col-md-6 nopad">
			        <div class="carousel1">
	        ...
	        <div class="blanco" style="display:none;"><!--  -->
		        <div class="col-md-6">
			        <h1>Family</h1>
			        <p>Amplias habitaciones cuádruples de 30 m² con vista a Puerto Madero o al Casco Histórico.</p>
			        <a href="habitaciones_family.php">RESERV&Aacute;</a>
		        </div>
		        <div class="col-md-6 nopad">
			        <div class="carousel1">
				        <div class="item"><img src="img/_habitaciones/05_Familiar/KER_Website_HABITACIONES_Familiar_01.jpg" alt="Classic_00"></div>
				        <div class="item"><img src="img/_habitaciones/05_Familiar/KER_Website_HABITACIONES_Familiar_02.jpg" alt="Classic_00"></div>
				        <div class="item"><img src="img/_habitaciones/05_Familiar/KER_Website_HABITACIONES_Familiar_03.jpg" alt="Classic_00"></div>
				        <div class="item"><img src="img/_habitaciones/05_Familiar/KER_Website_HABITACIONES_Familiar_04.jpg" alt="Classic_00"></div>
