...
?>
        ...
        <div class="videohome">
	        <div class="volumen" style="right:auto; left:51px;">
    	...
    	<video loop="loop" muted="muted" autoplay="autoplay" width="100%" id="videoreel">
					<source src="02_KER_SANTELMO_Video-Feb2020.mp4"/>
      				</video>
...
<?php include("protocolo_covid.php");?>  
        ...
        <div class="stay">
	        <div class="col-md-6">
		        ...
		        <h1>Stay a while</h1>
		        <p>Ker San Telmo se caracteriza por su estratégica ubicación dentro de un enclave turístico excepcional, a pocos metros del casco histórico de Buenos Aires, y a pasos de los principales atractivos de la Ciudad, rodeado de una innumerable variedad de restaurantes y cafés, con excelentes accesos a los principales aeropuertos y terminales de trasbordo.</p>
		        <h2><span>Explore rooms & suites</span></h2>
		        <a href="KER_SAN_TELMO_FactSheets_Frente-Dorso_BAJA.pdf" target="_blank" class="botonfact">DESCARGAR FACTSHEET</a>
		        <div class="clear"></div>
	        ...
	        <div class="col-md-6 col2 wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.9s">
		        <img src="img/01Home/Ker_Historic_SanTelmo_BsAs_Foto_Stayawhile.jpg" alt="Ker_Hotel_SanTelmo_BsAs_Foto_Stayawhile" class="img-responsive foto">
	        </div>
	        <div class="clear"></div>
        </div>
        ...
        <div class="trip">
	        <div class="col-md-6 wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.3s"><img src="img/01Home/Ker_Historic_SanTelmo_BsAs_Foto_Nuestros_huespedes.jpg" alt="Ker_Hotel_SanTelmo_BsAs_Foto_Nuestros_huespedes" class="img-responsive"></div>
        ...
        <div class="banner1">
	        <img src="img/01Home/Ker_Historic_SanTelmo_BsAs_Aplacetodiscover.jpg" alt="Ker_Hotel_SanTelmo_BsAs_Aplacetodiscover" class="img-responsive hidden-xs">
	        <img src="img/01Home/Ker_Historic_SanTelmo_BsAs_Aplacetodiscover_Mobile.jpg" alt="Ker_Hotel_SanTelmo_BsAs_Aplacetodiscover_Mobile" class="img-responsive hidden-md hidden-lg hidden-sm">
        </div>
        
        <div class="banner2">
	        <a href="halo.php"><img src="img/01Home/Banner_Halo.jpg" alt="Ker_Hotel_SanTelmo_BsAs_Aplacetodiscover" class="img-responsive hidden-xs"></a>
	        <a href="halo.php"><img src="img/01Home/Banner_Halo_Mobile.jpg" alt="Ker_Hotel_SanTelmo_BsAs_Aplacetodiscover_Mobile" class="img-responsive hidden-md hidden-lg hidden-sm"></a>
        </div>
        ...
        <div class="hoteles">
	        ...
	        <div class="col-md-4 col1 wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.3s">
			    ...
			    <img src="img/Home_Ker_Recoleta_logo.png">
		        <div class="barrita"></div>
	        ...
	        <div class="col-md-4 col1 wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.9s">
			    ...
			    <img src="img/Home_Ker_Belgrano_logo.png">
		        <div class="barrita"></div>
	        ...
	        <div class="col-md-4 col2 wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.6s">
			    ...
			    <img src="img/Home_Ker_Urquiza_logo.png">
		        <div class="barrita"></div>
...
<?php if($totalRows_promociones!=0){?>
  ...
  <div class="modal-body">
	<?php if($row_promociones['Id']==14 || $row_promociones['Id']==16){?>
			        <a href="https://reservations.travelclick.com/110467?room=Tipo+de+habitaci%C3%B3n&DateIn=&DateOut=&Adults=Huespedes&languageid=2#/guestsandrooms" target="_blank"><img src="img_promociones/<?php echo $row_promociones['foto_popup_esp']; ?>" width="100%"></a>
			        <?php } else {?>
