...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <title>Ker San Telmo Hotel - Stay a while - San Telmo - Buenos Aires</title>
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <link rel="shortcut icon" href="Favicon.jpg" type="image/x-icon">
		<link rel="icon" href="Favicon.jpg" type="image/x-icon">
		<meta name="description" content="Ker San Telmo, Hotel 4 estrellas Superior, dentro de un enclave turístico excepcional, cerca de los principales atractivos de la Ciudad, rodeado de una gran variedad de restaurantes y cafés, y con excelentes accesos a los principales aeropuertos y terminales de trasbordo.">
        <meta name="keywords" content="ker, hotel, buenos aires, caba, turismo, reserva, reservar, gastronomía, suites, habitaciones, halo, restaurante, salones, eventos, corporativos, hospedaje, estacionamiento, spa, argentina, estacionamiento, paseo colon, san telmo, casco historico">
...
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
        ...
        <header>
	        ...
	        <div class="col-md-3 logo">
		        <a href="index.php"><img src="img/Home_Ker_San_Telmo_logo.png"></a>
	        </div>
	        <div class="col-md-6">
		        <div class="menu1">
		        <ul class="menu">
		        ...
		        <ul class="menu">
			        <li class="linkhoteles"><a href="habitaciones.php">HABITACIONES</a>
			        	<div class="submenu" id="menuhoteles">
				        	<a href="habitaciones_classic.php">Classic</a>
				        	<a href="habitaciones_executive.php">Executive</a>
				        	<a href="habitaciones_deluxe.php">Deluxe</a>
			        	</div>
			        </li>
