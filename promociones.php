...
?>        
		...
		<img src="img/KER_Boton_Tax_free.jpg" class="tax" style="position:absolute; bottom:0px; z-index:99; right:0; width:16%;">
...
<?php } ?>        
        ...
        <div class="news">
	        ...
	        <div class="col-md-6"><img src="img/KER_Promociones_Rose_Halo_Modulo-Foto.jpg" alt="" class="img-responsive"/></div>
	        <div class="clear"></div>
        </div>
